...
-   **Purpose and patterns**: state the specific purpose(s) for which the model was developed, and the empirical observations (i.e. patterns) believed to be driven by the processes, variables, etc. described by the model.
